...
void C图形::f初始化(HWND a窗口) {
	...
	const 数学::S向量2 c纹理_左上 = {0, 0};
	const 数学::S向量2 c纹理_右上 = {1, 0};
	const 数学::S向量2 c纹理_左下 = {0, 1};
	const 数学::S向量2 c纹理_右下 = {1, 1};
	
	S顶点 va顶点[4] = {
		{{-c图形尺寸, c图形尺寸}, {{0, 0}, c纹理_左上, c纹理_左上, c纹理_左上}},
		{{c图形尺寸, c图形尺寸}, {{0.5f, 0}, c纹理_右上, c纹理_右上, c纹理_右上}},
		{{-c图形尺寸, -c图形尺寸}, {{0, 0.5f}, c纹理_左下, c纹理_左下, c纹理_左下}},
		{{c图形尺寸, -c图形尺寸}, {{0.5f, 0.5f}, c纹理_右下, c纹理_右下, c纹理_右下}},
	};
	三维::tp缓冲 v顶点缓冲;
	...
	//纹理
	三维::tp纹理资源视图 va纹理[4];
	v纹理工厂.f从文件创建纹理资源视图(va纹理[0], L"纹理1.png");
	v纹理工厂.f从文件创建纹理资源视图(va纹理[1], L"纹理2.png");
	v纹理工厂.f从文件创建纹理资源视图(va纹理[2], L"纹理3.png");
	v纹理工厂.f从文件创建纹理资源视图(va纹理[3], L"纹理4.png");
	ID3D11ShaderResourceView *va纹理1[4] = {
		va纹理[0].Get(),
		va纹理[1].Get(),
		va纹理[2].Get(),
		va纹理[3].Get(),
	};
	m三维.fg上下文()->PSSetShaderResources(0, 4, va纹理1);
